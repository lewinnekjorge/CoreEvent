...
class FlexExpand extends StatefulWidget {
  const FlexExpand({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<FlexExpand> createState() => _FlexExpandState();
}

// Expanded class:  widget que expande un hijo de una Fila, Columna o Flex para que el hijo llene el espacio disponible.
class _FlexExpandState extends State<FlexExpand> {
  @override
